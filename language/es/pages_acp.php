...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Al añadir enlaces de iconos a las páginas personalizados, puede que tenga que purgar el caché de iconos para ver los nuevos iconos. Coloque los iconos personalizados así, <samp>pages_ruta.gif</samp>, donde <samp>ruta</samp> es el nombre de la Página ruta, en phpBB las carpetas <samp>styles/*/theme/images/</samp>',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'El contenido puede crearse usando Markdown, BBCodes normales de phpBB, emoticonos y URLs mágicas, o se puede activar el modo HTML. En modo HTML, Markdown, los BBCodes, los emoticonos y las URLs mágicas no funcionarán, pero puede utilizar cualquier sintaxis HTML válida. Tenga en cuenta que este contenido se añadirá a una plantilla HTML existente, por lo que no debe incluir las etiquetas DOCTYPE, HTML, BODY o HEAD. Sin embargo, se pueden utilizar todas las demás etiquetas de formato HTML, incluyendo IFRAME, SCRIPT, STYLE, EMBED, VIDEO, etc.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Analizar Markdown',
