...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Quando si aggiungono icone alle pagine personalizzate potrebbe essere necessario eliminare la cache delle icone per poterle visualizzare. Per inserire le icone personalizzate è necessario denominarle es. <samp>pages_route.gif</samp>, dove <samp>route</samp> è il "nome percorso" della pagina. Inserire l´immagine nella cartella <samp>ROOT/styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Visualizza come titolo del link',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Il contenuto può essere creato utilizzando Markdown, i normali BBCode di phpBB, le faccine e gli URL automatici, oppure è possibile attivare la modalità HTML. In modalità HTML, Markdown, BBCode, faccine e URL automatici non funzionano, ma si è liberi di utilizzare qualsiasi sintassi HTML valida. Si prega di notare che questo contenuto verrà aggiunto a un modello HTML esistente, quindi non si dovrebbero includere i tag DOCTYPE, HTML, BODY o HEAD. Tuttavia, tutti gli altri tag di formattazione HTML, inclusi IFRAME, SCRIPT, STYLE, EMBED, VIDEO, ecc. possono essere utilizzati.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Analizza Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Icona del link della pagina',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Inserisci il nome di un’icona <strong><a href="%s" target="_blank">Font Awesome</a></strong> per usarla con il link della pagina. Lascia vuoto questo campo per usare le icone tradizionali CSS/GIF delle Pagine.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Mostra prima il titolo della pagina',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Per impostazione predefinita i browser mostreranno il titolo di questa pagina dopo il nome del sito <samp style="white-space: nowrap">“Nome del Sito - Titolo della Pagina”</samp>. Abilitare quest’opzione mostrera’ il titolo di questa pagina prima del nome del sito <samp style="white-space: nowrap">“Titolo della Pagina - Nome del Sito”</samp>.',
