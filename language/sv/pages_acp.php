...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'När du lägger till länkikoner för dina egna sidor kan det vara erforderligt att tömma ikoncachen för att kunna se nya ikoner. Placera egna ikoner med benämningen <samp>pages_nod.gif</samp>, där <samp>nod</samp> är sidans nod-benämning i phpBBs katalog <samp>styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Visa som länktitel',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Innehållet kan skapas med Markdown, normala phpBB-BBCode, smilies och magiska länkar eller så kan du aktivera HTML-läget. I HTML-läget kommer Markdown, BBCode, smilies och magiska länkar inte att fungera, men du kan använda valfri giltig HTML-kod. Observera att detta innehåll kommer att läggas till en existerande HTML-mall, så du bör inte lägga till taggarna DOCTYPE, HTML, BODY eller HEAD. Alla andra HTML-formaterande taggar inklusive IFRAME, SCRIPT, STYLE, EMBED, VIDEO, osv. får användas.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Tolka Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Ikon för sidlänk',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Ange namnet på en <strong><a href="%s" target="_blank">Font Awesome</a></strong>-ikon som ska användas med sidlänken. Lämna fältet tomt för att använda Pages traditionella CSS/GIF-bildikoner.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Visa sidtiteln först',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Webbläsare visar som standard sidans titel efter webbplatsens namn <samp style="white-space: nowrap">”Webbplatsens namn - Sidtitel”</samp>. Om du aktiverar detta alternativ visas sidtiteln före webbplatsens namn <samp style="white-space: nowrap">”Sidtitel - Webbplatsens namn”</samp>.',
