...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'При добавлении иконки к ссылке вам нужно очистить кеш иконок. Иконки должны иметь имя  <samp>pages_route.gif</samp>, где <samp>route</samp> - это путь, заданный в настройках конкретной страницы, иконки загружать в папку  <samp>styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Показывать как заголовок ссылки',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Содержимое можно создавать с помощью Markdown, обычных BBCode phpBB, смайликов и автоматически распознаваемых URL-адресов либо включить режим HTML. В режиме HTML Markdown, BBCode, смайлики и автоматически распознаваемые URL-адреса не работают, но можно использовать любой допустимый HTML-синтаксис. Обратите внимание, что это содержимое будет добавлено в существующий HTML-шаблон, поэтому не следует включать теги DOCTYPE, HTML, BODY или HEAD. Все остальные теги форматирования HTML, включая IFRAME, SCRIPT, STYLE, EMBED, VIDEO и другие, можно использовать.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Обрабатывать Markdown',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Показывать заголовок страницы первым',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'По умолчанию браузеры показывают заголовок этой страницы после названия сайта <samp style="white-space: nowrap">«Название сайта - Заголовок страницы»</samp>. При включении этой настройки заголовок страницы будет показан перед названием сайта <samp style="white-space: nowrap">«Заголовок страницы - Название сайта»</samp>.',
