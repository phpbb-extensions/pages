...
$lang = array_merge($lang, array(
	...
	'ACP_PAGES_FORM_ROUTE_EXPLAIN'		=> 'اسم مسار الصفحة الذي يستخدم كرابط للوصول إلى الصفحة. مثال : <samp>phpBB/page/route</samp>. المسموح فقط : الحروف , الأرقام , الواصلة ( - ) و ( _ ). يجب تعبئة هذا الحقل.',
