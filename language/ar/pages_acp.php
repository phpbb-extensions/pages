...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'قد تحتاج لحذف الملفات المؤقتة للأيقونات لكي تستطيع رؤية الايقونات الجديدة التي أضفتها للصفحة. تستطيع إضافة الأيقونات التي تريدها إلى المجلد <samp>styles/*/theme/images/</samp> على أن يكون بإسم <samp>pages_route.gif</samp> ( الـ <samp>route</samp> هو إسم مسار الصفحة )',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'عرضه كعنوان للرابط',
	'ACP_PAGES_FORM_CONTENT'			=> 'المحتوى',
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'يمكن إنشاء المحتوى باستخدام Markdown وأكواد BBCode العادية في phpBB والابتسامات والروابط التلقائية، أو يمكنك تفعيل وضع HTML. في وضع HTML، لن تعمل Markdown وأكواد BBCode والابتسامات والروابط التلقائية، ولكن يمكنك استخدام أي بنية HTML صالحة. يُرجى ملاحظة أن هذا المحتوى سيُضاف إلى قالب HTML موجود، لذلك يجب عدم تضمين وسوم DOCTYPE أو HTML أو BODY أو HEAD. ومع ذلك، يمكن استخدام جميع وسوم تنسيق HTML الأخرى، بما في ذلك IFRAME وSCRIPT وSTYLE وEMBED وVIDEO وغيرها.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'تحليل Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'أيقونة رابط الصفحة',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'أدخل اسم أيقونة من <strong><a href="%s" target="_blank">Font Awesome</a></strong> لاستخدامها مع رابط الصفحة. اترك هذا الحقل فارغًا لاستخدام أيقونات الصور التقليدية CSS/GIF لإضافة الصفحات.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'عرض عنوان الصفحة أولًا',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'تعرض المتصفحات افتراضيًا عنوان هذه الصفحة بعد اسم الموقع <samp style="white-space: nowrap">“اسم الموقع - عنوان الصفحة”</samp>. يؤدي تفعيل هذا الخيار إلى عرض عنوان الصفحة قبل اسم الموقع <samp style="white-space: nowrap">“عنوان الصفحة - اسم الموقع”</samp>.',
