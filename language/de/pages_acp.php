...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Wenn du selbstdefinierte Link-Icons hinzufügst musst du unter Umständen den Icon Cache löschen um neue Icons zu sehen. Lade benutzerdefinierte Icons mit dem Namen <samp>pages_route.gif</samp> nach <samp>styles/*/theme/images/</samp> hoch, wobei <samp>route</samp> der Name der URL route ist.',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Inhalt kann durch Markdown, BBCode, Smilies und magische URLs erstellt werden, oder du kannst den HTML-Modus nutzen. Im HTML-Modus funktionieren Markdown, BBCodes, Smilies und magische URLs nicht, aber es steht dir frei, beliebige valide HTML-Syntax zu verwenden. Bitte beachte, dass dieser Inhalt zu bestehendem HTML hinzugefügt wird und deshalb auf DOCTYPE-, HTML-, BODY- und HEAD-Tags verzichtet werden muss. Alle anderen HTML-Formatierungs-Tags inkl. IFRAME, SCRIPT, STYLE, EMBED, VIDEO etc. können jedoch verwendet werden.',
	...
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Gib den Namen eines <strong><a href="%s" target="_blank">Font-Awesome</a></strong>-Symbols ein, das für den Seitenlink verwendet werden soll. Lass dieses Feld leer, um die herkömmlichen CSS-/GIF-Bildsymbole von Pages zu verwenden.',
	...
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Standardmäßig zeigen Browser den Titel dieser Seite nach dem Namen der Website an <samp style="white-space: nowrap">„Name der Website - Seitentitel“</samp>. Wenn du diese Option aktivierst, wird der Seitentitel vor dem Namen der Website angezeigt <samp style="white-space: nowrap">„Seitentitel - Name der Website“</samp>.',
