...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Prilikom dodavanja ikona linkova prilagođenih stranica, (a) kako bi nove ikone postale vidljive, ponekad treba isprazniti priručnu memoriju ikona stranica.<br>Prilagođene ikone, nazvane npr. <samp>pages_route.gif</samp>, (a) gdje je <samp>route</samp> <em>usmjerno</em> ime stranice, pohranite u <samp>styles/*/theme/images/</samp> mape phpBBa.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Prikaži kao naslov poveznice',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Sadržaj može biti dodan korištenjem Markdowna, uobičajenih phpBB BBKodova, smajlića i “magičnih” linkova odnosno omogućavanjem HTML moda.<br>U HTML modu, Markdown, BBKodovi, smajlići i “magični” linkovi neće raditi, ali ste slobodan/na koristiti bilo koju ispravnu HTML sintaksu.<br />Sadržaj će biti dodan postojećem HTML predlošku, stoga, nemojte uključivati DOCTYPE, HTML, BODY i(li) HEAD tagove (dok) HTML tagove za uređivanje, uključujuć’ IFRAME, SCRIPT, STYLE, EMBED, VIDEO itd., možete koristiti.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Obradite Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Ikona poveznice stranice',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Unesite naziv ikone <strong><a href="%s" target="_blank">Font Awesome</a></strong> koja će se koristiti uz poveznicu stranice. Ostavite ovo polje prazno za korištenje tradicionalnih CSS/GIF slikovnih ikona proširenja Pages.',
	...
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Preglednici prema zadanim postavkama prikazuju naslov ove stranice nakon naziva web-mjesta <samp style="white-space: nowrap">„Naziv web-mjesta - Naslov stranice“</samp>. Omogućivanjem ove opcije naslov stranice prikazat će se prije naziva web-mjesta <samp style="white-space: nowrap">„Naslov stranice - Naziv web-mjesta“</samp>.',
