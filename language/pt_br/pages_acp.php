...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Ao adicionar ícones para as páginas personalizadas, limpe o cache de ícones para vê-los. Crie os ícones usando o padrão <samp>pages_route.gif</samp>, onde <samp>route</samp> é nome do caminho da página, na pasta <samp>phpbb/styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Exibir como título do link',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Na criação do conteúdo pode usar Markdown, BBCodes phpBB, smilies e URLs mágicos ou pode ativar o modo HTML. No modo HTML, Markdown, BBCodes, smilies e URLs mágicos não funcionam, mas pode usar qualquer sintaxe HTML válida. Atente que este conteúdo será mostrado no Template HTML existente, pelo que não deve incluir DOCTYPE, HTML, BODY ou tags HEAD. No entanto podem ser usadas todas as outras tags de formatação HTML, incluindo IFRAME, SCRIPT, STYLE, EMBED, VIDEO, etc.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Exibir primeiro o título da página',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Por padrão, os navegadores exibem o título desta página após o nome do site <samp style="white-space: nowrap">“Nome do site - Título da página”</samp>. Ao ativar esta opção, o título da página será exibido antes do nome do site <samp style="white-space: nowrap">“Título da página - Nome do site”</samp>.',
