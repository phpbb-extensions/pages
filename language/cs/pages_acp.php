...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Při přidávání vlastních ikon pro odkazy stránek může být potřeba pročištění cache, aby byly nové ikony vidět. Ikony s názvem <samp>pages_route.gif</samp>, kde <samp>route</samp> je název cesty stránky, umístěte do složky phpBB motivů <samp>styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Zobrazit jako titulek odkazu',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Obsah lze vytvořit pomocí Markdownu, BBCode, smajlíků a magic URL adres. Můžete také povolit HTML režim, ve kterém Markdown, BBCode, smajlíci ani magic URL adresy nebudou fungovat, ale můžete používat libovolnou platnou HTML syntaxi. Pamatujte, že tento obsah bude přidán do již existující šablony, takže byste neměli používat DOCTYPE, HTML, BODY nebo HEAD tagy. Všechny ostatní formátovací HTML značky jako např. IFRAME, SCRIPT, STYLE, EMBED, VIDEO, atp. použít lze.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Zpracovat Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Zadejte název ikony <strong><a href="%s" target="_blank">Font Awesome</a></strong>, která se použije u odkazu stránky. Chcete-li použít tradiční obrázkové ikony CSS/GIF rozšíření Pages, ponechte pole prázdné.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Zobrazit nejprve název stránky',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Ve výchozím nastavení prohlížeče zobrazí název této stránky za názvem webu <samp style="white-space: nowrap">„Název webu - Název stránky“</samp>. Zapnutím této možnosti se název stránky zobrazí před názvem webu <samp style="white-space: nowrap">„Název stránky - Název webu“</samp>.',
