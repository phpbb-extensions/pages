...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Ao adicionar links para ícones das páginas personalizadas, tem que limpar a cache de ícones para ver os novos ícones. Coloque os ícones personalizados, usando nomes <samp>pages_route.gif</samp>, onde <samp>route</samp> é nome do caminho da página, na pasta <samp>styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Mostrar como título da hiperligação',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Na criação do conteúdo pode usar Markdown, BBCodes phpBB, smilies e URLs mágicos ou pode ativar o modo HTML. No modo HTML, Markdown, BBCodes, smilies e URLs mágicos não funcionam, mas pode usar qualquer sintaxe HTML válida. Tenha em atenção que este conteúdo será mostrado no Template HTML existente, pelo que não deve incluir DOCTYPE, HTML, BODY ou tags HEAD. No entanto podem ser usadas todas as outras tags de formatação HTML, incluindo IFRAME, SCRIPT, STYLE, EMBED, VIDEO, etc.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Processar Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Ícone da hiperligação da página',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Introduza o nome de um ícone <strong><a href="%s" target="_blank">Font Awesome</a></strong> para utilizar com a hiperligação da página. Deixe este campo vazio para utilizar os ícones de imagem CSS/GIF tradicionais do Pages.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Mostrar primeiro o título da página',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Por predefinição, os navegadores mostram o título desta página após o nome do site <samp style="white-space: nowrap">“Nome do site - Título da página”</samp>. Ao ativar esta opção, o título da página será mostrado antes do nome do site <samp style="white-space: nowrap">“Título da página - Nome do site”</samp>.',
	'PARSE_HTML'						=> 'Processar HTML',
