...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Pri pridávaní vlastných ikon pre odkazy stránok môže byť potrebné prečistenie cache, aby boli nové ikony vidieť. Ikony s názvom <samp>pages_route.gif</samp>, kde <samp>route</samp> je názov cesty stránky, umiestnite do zložky phpBB motivov <samp>styles/*/theme/images/</samp>.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Zobraziť ako titulok odkazu',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Obsah sa môže vytvoriť pomocou Markdownu, BBCode, smajlíkov a magic URL adries. Môžete tiež povoliť HTML režim, v ktorom Markdown, BBCode, smajlíky ani magic URL adresy nebudú fungovať, ale môžete používať ľubovolnú platnú HTML syntax. Pamätajte, že tento obsah bude pridaný do už existujúcej šablony, takže by ste nemali používať DOCTYPE, HTML, BODY alebo HEAD tagy. Všetky ostatné formátovacie HTML značky ako napr. IFRAME, SCRIPT, STYLE, EMBED, VIDEO, atď. môžete použiť.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Spracovať Markdown',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Ikona odkazu stránky',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Zadajte názov ikony <strong><a href="%s" target="_blank">Font Awesome</a></strong>, ktorá sa použije pri odkaze stránky. Ak chcete použiť tradičné obrázkové ikony CSS/GIF rozšírenia Pages, ponechajte toto pole prázdne.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Zobraziť najprv názov stránky',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Prehliadače predvolene zobrazia názov tejto stránky za názvom webu <samp style="white-space: nowrap">„Názov webu - Názov stránky“</samp>. Zapnutím tejto možnosti sa názov stránky zobrazí pred názvom webu <samp style="white-space: nowrap">„Názov stránky - Názov webu“</samp>.',
