...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Özel sayfa bağlantı simgeleri eklediğiniz zaman, yeni simgeleri görmek için simge önbelleğini temizlemeniz gerekebilir. phpBB’nin <samp>styles/*/theme/images/</samp> dizinine <samp>pages_route.gif</samp> adında özel simge yerleştirdiğinizde, <samp>route</samp> Sayfa’nın yolu olacaktır.',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'İçerik Markdown, normal phpBB BBCode’ları, ifadeler ve sihirli URL’ler kullanılarak oluşturulabilir veya HTML modu etkinleştirilebilir. HTML modunda Markdown, BBCode’lar, ifadeler ve sihirli URL’ler çalışmaz; ancak geçerli herhangi bir HTML sözdizimini kullanabilirsiniz. Bu içerik mevcut bir HTML şablonuna ekleneceğinden DOCTYPE, HTML, BODY veya HEAD etiketlerini eklememelisiniz. Bununla birlikte IFRAME, SCRIPT, STYLE, EMBED, VIDEO vb. diğer tüm HTML biçimlendirme etiketleri kullanılabilir.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Markdown’ı ayrıştır',
