...
$lang = array_merge($lang, array(
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Indhold kan oprettes med Markdown, normale phpBB-BBkoder, smileys og magiske url’er, eller du kan aktivere HTML-tilstand. I HTML-tilstand virker Markdown, BBkoder, smileys og magiske url’er ikke, men du kan frit bruge gyldig HTML-syntaks. Bemærk venligst at indholdet tilføjes til en eksisterende HTML-skabelon, så du skal ikke inkludere DOCTYPE-, HTML-, BODY- eller HEAD-tags. Alle andre HTML-formateringstags, inklusive IFRAME, SCRIPT, STYLE, EMBED, VIDEO, osv. kan dog stadig bruges.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Fortolk Markdown',
