...
$lang = array_merge($lang, array(
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Als linktitel weergeven',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Inhoud kan aangemaakt worden met Markdown, normale phpBB-BBCodes, smilies en magische URL’s, of je kan de HTML-modus inschakelen. In HTML-modus werken Markdown, BBCodes, smilies en magische URL’s niet, maar je kan elke geldige HTML-syntaxis gebruiken. Let op dat deze inhoud aan een bestaande HTML-template wordt toegevoegd; voeg daarom geen DOCTYPE-, HTML-, BODY- of HEAD-tags toe. Alle andere HTML-opmaaktags, inclusief IFRAME, SCRIPT, STYLE, EMBED, VIDEO, enz. kunnen wel gebruikt worden.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Markdown verwerken',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Pictogram voor paginalink',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Voer de naam in van een <strong><a href="%s" target="_blank">Font Awesome</a></strong>-pictogram dat bij de paginalink moet worden gebruikt. Laat dit veld leeg om de traditionele CSS/GIF-afbeeldingspictogrammen van Pages te gebruiken.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Paginatitel eerst weergeven',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Browsers geven de titel van deze pagina standaard na de websitenaam weer <samp style="white-space: nowrap">“Websitenaam - Paginatitel”</samp>. Als deze optie is ingeschakeld, wordt de paginatitel vóór de websitenaam weergegeven <samp style="white-space: nowrap">“Paginatitel - Websitenaam”</samp>.',
