...
// 	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'Wenn Sie selbstdefinierte Link-Icons hinzufügen, müssen Sie unter Umständen den Icon-Cache löschen, um neue Icons zu sehen. Legen Sie eigene Icons mit dem Namen <samp>pages_route.gif</samp>, wobei <samp>route</samp> der Routenname der Seite ist, in den phpBB-Verzeichnissen <samp>styles/*/theme/images/</samp> ab.',
	...
	'ACP_PAGES_FORM_DESC_DISPLAY'		=> 'Als Linktitel anzeigen',
	...
	'ACP_PAGES_FORM_ICON_FONT'			=> 'Symbol für Seitenlink',
	'ACP_PAGES_FORM_ICON_FONT_EXPLAIN'	=> 'Geben Sie den Namen eines <strong><a href="%s" target="_blank">Font-Awesome</a></strong>-Symbols ein, das für den Seitenlink verwendet werden soll. Lassen Sie dieses Feld leer, um die herkömmlichen CSS-/GIF-Bildsymbole von Pages zu verwenden.',
	...
	'ACP_PAGES_TITLE_SWITCH'			=> 'Seitentitel zuerst anzeigen',
	'ACP_PAGES_TITLE_SWITCH_EXPLAIN'	=> 'Standardmäßig zeigen Browser den Titel dieser Seite nach dem Namen der Website an <samp style="white-space: nowrap">„Name der Website - Seitentitel“</samp>. Wenn Sie diese Option aktivieren, wird der Seitentitel vor dem Namen der Website angezeigt <samp style="white-space: nowrap">„Seitentitel - Name der Website“</samp>.',
	'PARSE_HTML'						=> 'HTML verarbeiten',
