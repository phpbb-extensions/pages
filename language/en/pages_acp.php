...
//	'ACP_PAGES_PURGE_ICONS_EXPLAIN'		=> 'When adding custom page link icons, you may need to purge the icon cache to see the new icons. Place custom icons named <samp>pages_route.gif</samp>, where <samp>route</samp> is the Page’s route name, in phpBB’s <samp>styles/*/theme/images/</samp> folders.',
	...
	'ACP_PAGES_FORM_DESC_EXPLAIN'		=> 'This will be displayed in the ACP list of pages. Enable “Display as link title” to show this description to the user when the mouse hovers over a link to this page.',
	...
	'ACP_PAGES_FORM_CONTENT_EXPLAIN'	=> 'Content can be created using Markdown, normal phpBB BBCodes, smilies and magic urls or you can enable HTML mode. In HTML mode, Markdown, BBCodes, smilies and magic urls will not work, but you are free to use any valid HTML syntax. Please note that this content will be added to an existing HTML template, so you should not include DOCTYPE, HTML, BODY or HEAD tags. However, all other HTML formatting tags, including IFRAME, SCRIPT, STYLE, EMBED, VIDEO, etc. can be used.',
	'ACP_PAGES_PARSE_MARKDOWN'			=> 'Parse Markdown',
